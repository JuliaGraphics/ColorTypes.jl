...
red(c::RGB565) = reinterpret(N3f5, (c.value & 0xf800) >> 11)
...
green(c::RGB565) = reinterpret(N2f6, (c.value & 0x07e0) >> 5)
...
blue(c::RGB565) = reinterpret(N3f5, c.value & 0x001f)
...
reinterpret(::Type{UInt16}, c::RGB565) = c.value
